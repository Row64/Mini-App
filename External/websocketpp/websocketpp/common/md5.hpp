...
void md5_append(md5_state_t *pms, md5_byte_t const * data, size_t nbytes) {
    ...
    pms->count[1] += static_cast<md5_word_t>(nbytes >> 29); // Row64: Compilation warning fix applied from https://github.com/zaphoyd/websocketpp/blob/develop/websocketpp/common/md5.hpp
    pms->count[0] += nbits;
