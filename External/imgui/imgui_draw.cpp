...
void ImDrawList::PrimReserve(int idx_count, int vtx_count)
{
    ...
    // Row64:  Row64 extends the vertex structure to contain a texture ID.
    // None of the ImGui drawing primitives "know" about this field and so is
    // left uninitialized.  Some Row64 drawing functions that use a specific texID
    // explicitly set this field.  But other drawing functions that assume a default
    // value will end up using an uninitialized value unless we do this:
    for (int i = 0; i < abs(vtx_count); i++)
    {
        _VtxWritePtr[i].texID = -1;
    }
...
static const char proggy_clean_ttf_compressed_data_base85[2] ="7";
static const char* GetDefaultCompressedFontDataTTFBase85()
{
